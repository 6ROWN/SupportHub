...
import { editTicket, reset } from "../../features/tickets/ticketSlice";
...
const EditTicket = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		// Dispatch createTicket action with formData
		dispatch(editTicket({ ticketId: ticket._id, ticketData: formData }));
		...
		<div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
			<div className="max-w-4xl w-full space-y-8 p-10 bg-white shadow-md rounded-lg">
				...
				<div>
					<button
						onClick={() => navigate(-1)}
						className=" w-full bg-red-300 text-white font-medium py-3 px-4 rounded-lg hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-300"
					>
						CANCEL
					</button>
				</div>
